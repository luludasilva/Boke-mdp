...
import PantalonesImage1 from '../assets/Articulos/pan1.jpg';
import PantalonesImage2 from '../assets/Articulos/pan2.jpg';
import PantalonesImage3 from '../assets/Articulos/pan3.jpg';
import PantalonesImage4 from '../assets/Articulos/pan4.jpg';
import { IoIosArrowDropleftCircle } from "react-icons/io";
import Footer from './Footer';

const DetallesPantalones = () => {
  const [currentImage, setCurrentImage] = useState(0);

  const producto = {
    nombre: 'Descripción del Artículo',
    descripcion:
      'Pantalones de Gasa de Algodón estampados en Serigrafía. Capsula Exclusiva. Cuidados: Lavar con Agua fría. No centrifugar. Planchado mínimo.  Producto 100%Artesanal. Consultar por talles Disponibles',
    fotos: [PantalonesImage1, PantalonesImage2, PantalonesImage3, PantalonesImage4],
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row p-4">
        <div className="lg:w-1/2">
          <h1 className="text-3xl font-bold mb-4 lg:self-center">Pantalones</h1>
...
export default DetallesPantalones;